...
<div style="font-size: 15px;">
 ...
 <?php echo $motivo ?>.</p>
 <p style="margin-left:45px">Confirmo a validade do presente atestado, conforme o artigo 473 da CLT, a Lei nº 605/1949 e <p> 
	Art. 159 do Dec. nº 10.854/2021 da Legislação e Direitos do Trabalhador. O paciente estará apto a voltar ao <p>trabalho após o período de afastamento.</p>
</div>
<?php if($obs != ""){ ?>
