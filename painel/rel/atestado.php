...
<div style="font-size: 15px;">
	<p style="margin-left:50px">Atesto para fins trabalhistas que o Sr(a) <b><?php echo $nome_paciente ?></b> portador do CPF nº: <?php echo $cpf_paciente ?> <p>esteve sob cuidados profissionais
		 no dia __/__/____, e deverá se afastar de suas atividades pelo período de <p><b><?php echo $dias ?> dias </b> por motivo de <?php echo $motivo ?>.</p>
	<p style="margin-left:50px">Este atestado é válido para fins legais.</p>
	<p style="margin-left:50px">Sem mais para o momento, coloco-me à disposição para quaisquer esclarecimentos.</p>	
