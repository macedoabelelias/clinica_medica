				...
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-md-3 mb-3">
							...
							<input type="number" class="form-control" id="intervalo" name="intervalo" placeholder="Intervalo Minutos">
						</div>

						<div class="col-md-3 mb-3">
							<label>CRM</label>
							<input type="text" class="form-control" id="cro" name="cro" placeholder="CRO">
						</div>
					</div>
						...
						<div class="tile">
							<div class="table-responsive">
								<table id="" class="text-left table table-bordered">
									...
									<tr>
										<td class="bg-primary text-white w_150">Intervalo</td>
										<td><span id="intervalo_dados"></span> Minutos</td>
									</tr>
								
									<tr>
										<td class="bg-primary text-white w_150">CRO</td>
										<td><span id="cro_dados"></span></td>
									</tr>
									<tr>
	...
	<div class="modal fade" id="modalProcedimentos" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
		<div class="modal-dialog" >
			<div class="modal-content" >
				...
				<button id="btn-fechar-procedimentos" aria-label="Close" class="btn-close" data-bs-dismiss="modal"
					type="button"><span class="text-white" aria-hidden="true">&times;</span></button>
			</div>
				...
				<form id="form_procedimento">
					<div class="modal-body">
						<div class="row">
							<div class="col-md-8">
								<select class="sel_proc" name="procedimento" id="procedimento" required style="width:100%">
									<?php 
							...
							<div class="" id="listar_procedimentos">
							</div>
							<br>
		...
		<div class="modal fade" id="modalHorarios" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg" >
				...
				<button id="btn-fechar-horario" aria-label="Close" class="btn-close" data-bs-dismiss="modal"
					type="button"><span class="text-white" aria-hidden="true">&times;</span></button>
			</div>
					<div class="modal-body">
						<form id="form-dias">
							<div class="row">
								<div class="col-md-3" style="margin-top: 0px">						
									<div class="form-group">
										<label for="exampleInputEmail1">Dia ou Data</label>
										...
										<input class="form-control" type="date" name="data" id="data_exp" style='margin-top: 3px'>  
									</div>
								</div>
