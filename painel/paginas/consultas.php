		...
		<div class="modal-content ">
			<div class="modal-header bg-primary text-white">
				<h4 class="modal-title" id="exampleModalLabel"><span id="nome_dados"></span>
					<span style="margin-left: 725px; font-size: 15px"><a title="PDF da Ficha Paciente" href="" onclick="ficha()"><i class="fa fa-file-pdf-o text-danger"></i> Imprimir Ficha</a></span>
				</h4>
			...
			<div class="modal-body">
				...
				<div class="row">
					<div class="col-md-10">	
								...
								<input type="text" id="descricao_raiox" name="descricao_raiox" class="form-control" placeholder="Descrição do Exame">			
							</div>						
...
function inserirItem(){
	...
	if(remedio == ""){
		alert("Prencha o nome do medicamento!");
		return;
	}
